...
const Tile = ({ peerId, width = "100%", height = "100%" }: any) => {
  const track: any = useHMSStore(selectScreenShareByPeerID(peerId));
  const peer: any = useHMSStore(selectPeerByID(peerId));
