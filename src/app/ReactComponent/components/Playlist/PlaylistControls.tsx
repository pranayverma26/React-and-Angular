...
const Progress = ({ type, duration }: any) => {
...
const VolumeControl = () => {
  ...
  const sliderVolume: any = active ? volume : audioTrackVolume;
...
export const AudioPlaylistControls = ({ onToggle }: any) => {
...
export const VideoPlaylistControls = ({ children }: any) => {
