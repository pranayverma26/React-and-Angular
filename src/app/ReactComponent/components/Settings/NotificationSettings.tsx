...
const NotificationItem = ({ type, label, icon, checked }: any) => {
  const [, setSubscribedNotifications]: any = useSetSubscribedNotifications(type);
  return (
    <SwitchWithLabel
      label={label}
      id={type}
...
export const NotificationSettings = () => {
  const subscribedNotifications: any = useSubscribedNotifications(null);
