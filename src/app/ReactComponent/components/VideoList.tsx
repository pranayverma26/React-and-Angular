...
const List = ({
  ...
  const tileOffset: any = useAppConfig("headlessConfig", "tileOffset");
  const isHeadless: any = useIsHeadless();
  const { ref, pagesWithTiles } = useVideoList({
    ...
    includeScreenShareForPeer,
    aspectRatio,
    offsetY: getOffset({ isHeadless: isHeadless, offset: tileOffset }),
  });
...
const getOffset = ({ offset, isHeadless }: any) => {
