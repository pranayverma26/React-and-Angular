...
export function HlsStatsOverlay({ hlsStatsState, onClose }: any) {
  return (
    <Flex
      css={{
        position: "absolute",
 ...
 */
export function getDurationFromSeconds(timeInSeconds: any) {
...
const HlsStatsRow = memo(({ label, children }: any) => {
  return (
