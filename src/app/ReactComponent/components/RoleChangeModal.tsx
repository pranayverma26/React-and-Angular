...
const PeerName = forwardRef(({ children, maxWidth, ...rest }: any, ref) => (
  <Text
    {...rest}
    ref={ref}
    as="strong"
...
export const RoleChangeModal = ({ peerId, onOpenChange }: any) => {
  ...
  const [peerNameRef, setPeerNameRef]: any = useState();
          ...
          {!peer.isLocal && (
            <Flex justify="between" css={{ w: "100%", mb: "$10" }}>
              ...
              <Checkbox.Root
                ...
                onCheckedChange={(value: any) => setRequestPermission(value)}
