...
const MessageTypeContainer = ({ left, right }: any) => {
  return (
    <Flex
      align="center"
      css={{
...
export const AnnotisedMessage = ({ message }: any) => {
  if (!message) {
    return <Fragment />;
  }
...
const getMessageType = ({ roles, receiver }: any) => {
...
const ChatMessage = React.memo(
  ({ message, autoMarginTop = false, onPin }: any) => {
...
export const ChatBody = ({ role, peerId, setPinnedMessage }: any) => {
