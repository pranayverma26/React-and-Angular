...
const Tile = ({ peerId, trackId, width, height }: any) => {
  ...
  const headlessConfig: any = useAppConfig("headlessConfig");
...
const getPadding = ({ isHeadless, offset }: any) => {
