 ...
 */
export const useSetUiSettings = (uiSettingKey: any) => {
...
export const useSetSubscribedNotifications = (notificationKey: any) => {
...
export const useSetAppDataByKey = (appDataKey: any) => {
...
const useSetAppData = ({ key1, key2 }: any) => {
  const actions = useHMSActions();
