...
export const ContentHeader = ({ onBack, title, content }: any) => {
  return (
...
export const ContentBody = ({ Icon, title, children }: any) => {
  return (
    <Box css={{ p: "$10" }}>
...
export const RecordStream = ({ record, setRecord, testId }: any) => {
