...
export const SidePane = ({
  ...
  const shouldShowScreenFn = useCallback(
    (peer: any) => peerScreenSharing && peer.id !== peerScreenSharing.id,
    [peerScreenSharing]
  );
  return (
    <Fragment>
...
const ScreenShareComponent = ({
  ...
  const screenshareTrack: any = useHMSStore(
...
const LargeTilePeerView = ({ peerScreenSharing, showStatsOnTiles }: any) => {
