...
class PusherCommunicationProvider {
  ...
  init = (roomId = '') => {
    ...
    /** @private */
    this.pusher = new Pusher(enviornmentConstant.REACT_APP_PUSHER_APP_KEY, {
      cluster: 'ap2',
      authEndpoint: enviornmentConstant.REACT_APP_PUSHER_AUTHENDPOINT,
    });
   ...
   * @param {any} message
   */
  storeEvent = (eventName: any, message: any) => {
   ...
   * @param {Object} arg
   */
  broadcastEvent = (eventName: any, arg = {}) => {
